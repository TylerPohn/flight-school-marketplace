...
export const detailedMockSchools: DetailedSchool[] = [
...

  {
    ...
    costBand: { min: 13800, max: 13800 },
    trainingType: 'Part141',
    trustTier: TrustTier.VERIFIED_FSP as TrustTier,

    description: `Northwest Aviation Academy has been training pilots in the Pacific Northwest since 2008, building a reputation for excellence in challenging weather conditions. Located in Seattle, we specialize in teaching students to master variable weather, complex airspace, and mountain flying procedures. Our comprehensive training environment prepares pilots for real-world conditions they'll encounter throughout their careers. With the Cascade Range to the east and the Olympic Mountains to the west, our students gain invaluable experience with terrain awareness, weather decision-making, and mountain flying techniques that set them apart from pilots trained in easier environments.`,
    ...
    fleetDetails: [
      {
        ...
        maxAltitude: 14000,
        cruiseSpeed: 122,
        equipment: ['G1000 NXi', 'Autopilot', 'ADS-B Out', 'WAAS GPS'],
        availability: 'High'
      },
      {
        aircraftType: 'Diamond DA40',
        ...
        maxAltitude: 16400,
        cruiseSpeed: 135,
        equipment: ['Glass Cockpit', 'Autopilot', 'FIKI Capable', 'G1000'],
        availability: 'High'
      },
      {
        ...
        maxAltitude: 15000,
        cruiseSpeed: 145,
        equipment: ['IFR Certified', 'Retractable Gear', 'Constant Speed Prop', 'Garmin 430'],
        availability: 'Medium'
      }
    ],
    ...
    instructors: [
      {
        id: 'instr-061',
        name: 'Captain Rebecca Foster',
        certificates: ['CFI', 'CFII', 'MEI', 'ATP'],
        yearsExperience: 18,
        bio: 'Former Alaska Airlines pilot with extensive mountain flying experience. Specializes in weather decision-making and challenging terrain operations. Rebecca has over 15,000 hours and brings real-world airline experience to every lesson.',
        photoUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-062',
        ...
        certificates: ['CFI', 'CFII'],
        yearsExperience: 9,
        bio: 'Pacific Northwest native with deep knowledge of local weather patterns and terrain. Known for his systematic teaching approach and emphasis on aeronautical decision-making. Excellent with instrument students navigating Seattle\'s marine layer.',
        photoUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-063',
        ...
        certificates: ['CFI', 'CFII', 'MEI'],
        yearsExperience: 12,
        bio: 'Formerly flew corporate jets in the Northwest before transitioning to flight instruction. Specializes in advanced instrument procedures and complex aircraft transitions. Her students consistently praise her attention to detail and professional standards.',
        photoUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-064',
        ...
        certificates: ['CFI', 'CFII'],
        yearsExperience: 7,
        bio: 'Young but highly skilled instructor who relates well to millennial and Gen-Z students. Excellent with nervous first-time students and building confidence. Focuses on modern cockpit resource management and technology integration.',
        photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop'
      }
    ],
    ...
    programDetails: [
      {
        ...
        costMin: 13000,
        costMax: 14500,
        description: 'Comprehensive private pilot training with emphasis on Pacific Northwest weather and terrain. Includes mountain flying introduction, marine layer operations, and complex airspace procedures. 45 flight hours, 25 ground instruction hours, and thorough preparation for the FAA practical exam.'
      },
      {
        name: 'Instrument Rating (IR)',
        certification: 'IR',
        ...
        costMin: 5500,
        costMax: 6300,
        description: 'Master instrument flight in one of the most challenging weather environments in the country. Learn to safely navigate Seattle\'s marine layers, mountain obscuration, and rapidly changing conditions. 40 flight hours including simulator time and actual IMC when conditions permit.'
      },
      {
        name: 'Commercial Pilot License (CPL)',
        certification: 'CPL',
        ...
        costMin: 8000,
        costMax: 9000,
        description: 'Professional pilot training to commercial standards. Advanced maneuvers, complex aircraft operations, and commercial procedures. Includes mountain flying techniques and challenging terrain operations that prepare you for professional aviation careers in the Pacific Northwest.'
      },
      {
        ...
        costMin: 4500,
        costMax: 5500,
        description: 'Learn to teach instrument flight procedures to the highest standards. Focuses on effective teaching techniques, weather analysis instruction, and building confident instrument pilots. Ideal for those pursuing a career in flight instruction.'
      }
    ],
    ...
    reviews: [
      {
        id: 'review-061',
        reviewerName: 'Brandon Mitchell',
        date: '2025-10-22',
        rating: 5,
        title: 'Best Training for Real-World Conditions',
        body: 'Training in Seattle weather made me a much better pilot than I would have been elsewhere. Rebecca Foster taught me to read weather like a pro and make smart go/no-go decisions. The mountain flying experience near the Cascades was incredible and gave me skills I use constantly.',
        helpful: 26
      },
      {
        id: 'review-062',
        reviewerName: 'Sophia Ramirez',
        date: '2025-10-08',
        rating: 4,
        title: 'Thorough Training, Weather Can Be Challenging',
        body: 'The instruction is top-notch and the fleet is well-maintained. Just be prepared for weather delays - that\'s Seattle for you. Tyler was patient and used the downtime for excellent ground instruction. You\'ll definitely earn your wings here!',
        helpful: 19
      },
      {
        id: 'review-063',
        ...
        body: 'Northwest Aviation prepared me better than I could have imagined. The G1000 training was excellent, and learning to navigate Seattle\'s complex airspace has made flying anywhere else feel easy. Jennifer Park is an outstanding CFII who really knows her stuff.',
        helpful: 31
      },
      {
        id: 'review-064',
        ...
        date: '2025-08-28',
        rating: 4,
        title: 'Great School with Minor Scheduling Issues',
        body: 'Fantastic instructors and really good training program. Aircraft availability can be tight during summer months, so book ahead. The simulator helped bridge gaps when weather grounded us. Overall very happy with my training here.',
        helpful: 14
      },
      {
        id: 'review-065',
        ...
        date: '2025-07-19',
        rating: 5,
        title: 'Mountain Flying Experience is Invaluable',
        body: 'The proximity to the Cascades means you get real mountain flying experience during your training. This is huge if you plan to fly in the western US. Marcus was great at explaining density altitude and terrain awareness. Highly recommend!',
        helpful: 22
      }
    ],
    ...
    verificationDetails: {
      ...
      fspSignals: {
        avgHoursToPPL: 62.4,
        scheduleConsistency: 81,
        instructorReliability: 89
      }
    },

    contactInfo: {
      email: 'info@northwestaviation.com',
      phone: '(206) 555-0142',
      website: 'https://northwestaviation.com'
    }
  },

  {
    ...
    programs: ['PPL', 'IR', 'CPL'],
    costBand: { min: 15200, max: 15200 },
    trainingType: 'Part141',
    trustTier: TrustTier.PREMIER as TrustTier,

    description: `Boston Flight Academy stands as one of New England's most prestigious flight training institutions, serving the aviation community since 2003. Situated in the historic birthplace of American aviation, we combine traditional excellence with modern training methodology. Our students master some of the nation's most challenging airspace, including Boston's Class B, while experiencing the full spectrum of New England weather from coastal fog to winter operations. This demanding environment produces exceptionally competent pilots who excel in any flying situation. Our alumni fly for major airlines, corporate flight departments, and military branches worldwide.`,

    yearsInOperation: 21,
    facilities: [
      'Redbird MCX Flight Simulators (2)',
    ...
    fleetDetails: [
      {
        ...
        maxAltitude: 14000,
        cruiseSpeed: 122,
        equipment: ['G1000', 'Autopilot', 'ADS-B Out', 'WAAS GPS'],
        availability: 'High'
      },
      {
        aircraftType: 'Piper Warrior III',
        count: 3,
        maxAltitude: 12500,
        cruiseSpeed: 115,
        equipment: ['Garmin 430W', 'IFR Certified', 'ADS-B Out', 'Mode C Transponder'],
        availability: 'Medium'
      }
    ],
    ...
    instructors: [
      {
        id: 'instr-065',
        name: 'Captain William Harrison',
        certificates: ['CFI', 'CFII', 'MEI', 'ATP'],
        yearsExperience: 22,
        bio: 'Retired JetBlue captain with over 18,000 hours of flight time. Bill brings decades of experience navigating Boston\'s complex airspace and New England weather. Known for his methodical approach and emphasis on professional standards from day one.',
        photoUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-066',
        name: 'Dr. Patricia O\'Brien',
        certificates: ['CFI', 'CFII'],
        yearsExperience: 14,
        bio: 'Former MIT professor of aerospace engineering turned flight instructor. Combines technical knowledge with practical flying skills. Exceptional at explaining complex concepts in understandable terms. Specializes in instrument training and weather theory.',
      ...
      },
      {
        ...
        certificates: ['CFI', 'CFII', 'MEI'],
        yearsExperience: 11,
        bio: 'Boston native who knows every inch of local airspace. Former charter pilot with extensive experience in challenging weather conditions. Students appreciate his calm demeanor and ability to teach complex airspace procedures with clarity.',
        photoUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-068',
        ...
        certificates: ['CFI', 'CFII'],
        yearsExperience: 8,
        bio: 'Career changer from software engineering to aviation, bringing analytical thinking to flight instruction. Excellent with detail-oriented students and those who learn best with structured, systematic approaches. Specializes in primary training and instrument procedures.',
        photoUrl: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=200&h=200&fit=crop'
      }
    ],
    ...
    programDetails: [
      {
        ...
        costMin: 14500,
        costMax: 16000,
        description: 'Premium private pilot training in one of the nation\'s most challenging and educational airspace environments. Master Boston Class B operations, coastal weather patterns, and New England seasonal variations. 45 flight hours, 30 ground instruction hours, comprehensive exam preparation, and personalized instruction tailored to your learning style.'
      },
      {
        name: 'Instrument Rating (IR)',
        certification: 'IR',
        ...
        costMin: 6000,
        costMax: 7000,
        description: 'Advanced instrument training leveraging New England\'s variable weather conditions for real-world experience. Learn precise instrument approaches into Boston\'s busy airports, master coastal fog operations, and develop exceptional IFR decision-making skills. 40 flight hours plus extensive simulator training.'
      },
      {
        name: 'Commercial Pilot License (CPL)',
        certification: 'CPL',
        ...
        costMin: 8500,
        costMax: 9500,
        description: 'Professional pilot training to the highest commercial standards. Advanced flight maneuvers, complex aircraft operations, and professional procedures in busy terminal airspace. Our commercial graduates are sought after by regional airlines and charter operators throughout the Northeast.'
      }
    ],
    ...
    reviews: [
      {
        id: 'review-066',
        reviewerName: 'Thomas Reynolds',
        date: '2025-10-30',
        rating: 5,
        title: 'World-Class Training in Challenging Airspace',
        body: 'Learning to fly in Boston Class B made me a sharp, confident pilot. Captain Harrison\'s instruction was impeccable - professional, thorough, and always safety-focused. The complex airspace and variable weather created the perfect training environment. Worth every penny.',
        helpful: 34
      },
      {
        id: 'review-067',
        reviewerName: 'Rachel Goldman',
        date: '2025-10-14',
        rating: 5,
        title: 'Exceeded All Expectations',
        body: 'Dr. O\'Brien is an incredible instructor who made complex concepts easy to understand. The fleet is well-maintained, scheduling is professional, and the overall experience was outstanding. Passed my checkride on the first attempt with flying colors!',
        helpful: 28
      },
      {
        id: 'review-068',
        reviewerName: 'Kevin Murphy',
        date: '2025-09-26',
        rating: 4,
        title: 'Excellent Training, Premium Pricing',
        body: 'Top-tier instruction and a professional operation from start to finish. The cost is higher than some schools, but you get what you pay for. Michael Sullivan was patient and thorough. The New England weather taught me real decision-making skills.',
        helpful: 21
      },
      {
        id: 'review-069',
        reviewerName: 'Sarah Matthews',
        date: '2025-08-19',
        rating: 5,
        title: 'Best Decision for My Aviation Career',
        body: 'Boston Flight Academy prepared me for a career in aviation, not just a license. The emphasis on professionalism, precise flying, and complex operations set me apart in airline interviews. Lisa was fantastic and really invested in my success.',
        helpful: 25
      },
      {
        id: 'review-070',
        ...
        date: '2025-07-11',
        rating: 4,
        title: 'Rigorous and Rewarding',
        body: 'This school doesn\'t hand out licenses - you earn them. The standards are high, which pushed me to be better. Weather delays are part of training in Boston, but the instructors used that time productively. Left as a much better pilot than I could have imagined.',
        helpful: 18
      }
    ],
    ...
    verificationDetails: {
      trustTier: 'Premier',
      verificationTimestamp: '2025-08-20T00:00:00Z',
      dataSources: ['FSP Integration', 'Claimed Profile', 'Student Reviews', 'FAA Records', 'Third-Party Audit'],
      lastUpdated: '2025-11-06T00:00:00Z',
      fspSignals: {
        avgHoursToPPL: 63.1,
        scheduleConsistency: 93,
        instructorReliability: 95
      }
    },

    contactInfo: {
      email: 'info@bostonflightacademy.com',
      phone: '(617) 555-0198',
      website: 'https://bostonflightacademy.com'
    }
  },

  {
    ...
    programs: ['PPL', 'IR'],
    costBand: { min: 11500, max: 11500 },
    trainingType: 'Part61',
    trustTier: TrustTier.COMMUNITY_VERIFIED as TrustTier,

    description: `Chicago Sky Institute has been serving the Chicagoland aviation community since 2012, offering personalized Part 61 flight training with a focus on individual student needs and flexible scheduling. Located in the heart of the Midwest, we provide excellent training value while maintaining high safety standards and quality instruction. Our students gain invaluable experience operating in and around Chicago's busy Class B airspace, learning to communicate professionally with air traffic control and navigate one of the nation's busiest terminal environments. We pride ourselves on a tight-knit community atmosphere where instructors know each student personally and tailor instruction to individual learning styles and career goals.`,
    ...
    fleetDetails: [
      {
        ...
        maxAltitude: 13500,
        cruiseSpeed: 120,
        equipment: ['Dual Nav/Com', 'Transponder', 'ADS-B Out', 'IFR Certified'],
        availability: 'High'
      },
      {
        aircraftType: 'Cessna 152',
        ...
        maxAltitude: 12000,
        cruiseSpeed: 107,
        equipment: ['VOR/ILS', 'Transponder', 'Intercom', 'Basic IFR'],
        availability: 'Medium'
      }
    ],
    ...
    instructors: [
      {
        ...
        certificates: ['CFI', 'CFII'],
        yearsExperience: 16,
        bio: 'Chicago-based instructor with deep knowledge of Midwest weather patterns and Class B operations. Former corporate pilot who brings real-world experience to every lesson. Known for his patient teaching style and emphasis on practical skills that matter in everyday flying.',
        photoUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-070',
        ...
        certificates: ['CFI', 'CFII'],
        yearsExperience: 7,
        bio: 'Energetic and enthusiastic instructor who makes learning to fly fun and accessible. Excellent at breaking down complex procedures into manageable steps. Her students consistently praise her encouraging approach and clear communication style.',
        photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop'
      },
      {
        id: 'instr-071',
        ...
        certificates: ['CFI', 'ATP'],
        yearsExperience: 13,
        bio: 'Former freight pilot with extensive single-pilot IFR experience in challenging Midwest weather. Specializes in teaching real-world decision-making and risk management. Students value his practical approach and focus on becoming safe, competent pilots.',
        photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop'
      }
    ],
    ...
    programDetails: [
      {
        ...
        costMin: 10800,
        costMax: 12200,
        description: 'Flexible Part 61 private pilot training tailored to your schedule and learning pace. Train in Chicago\'s dynamic airspace environment, gaining experience with Class B operations, Midwest weather, and professional radio communications. Self-paced program with minimum 40 flight hours, comprehensive ground instruction, and thorough checkride preparation.'
      },
      {
        name: 'Instrument Rating (IR)',
        certification: 'IR',
        ...
        costMin: 4500,
        costMax: 5500,
        description: 'Comprehensive instrument training in real-world IFR conditions. Master Chicago approach procedures, learn to handle rapidly changing Midwest weather, and develop the skills to fly safely in instrument conditions. Flexible scheduling to accommodate working professionals. Minimum 40 hours instrument time including actual IMC when available.'
      }
    ],
    ...
    reviews: [
      {
        ...
        date: '2025-10-18',
        rating: 5,
        title: 'Great Value and Personal Attention',
        body: 'Chicago Sky Institute offered exactly what I was looking for - quality instruction without the premium price tag. Robert Jensen was patient and thorough, and the flexible Part 61 structure let me train at my own pace while working full-time. Highly recommend!',
        helpful: 20
      },
      {
        id: 'review-072',
        ...
        date: '2025-09-29',
        rating: 4,
        title: 'Solid Training, Older Aircraft',
        body: 'The instruction quality is excellent and the instructors really care about your progress. The aircraft are older but well-maintained and perfectly fine for training. Amanda was a great CFI who made me feel comfortable from day one. Good school for budget-conscious students.',
        helpful: 16
      },
      {
        id: 'review-073',
        ...
        date: '2025-09-05',
        rating: 4,
        title: 'Friendly Atmosphere, Good Training',
        body: 'Small school with a real community feel. Everyone knows your name and instructors are genuinely invested in your success. Training in Chicago Class B built my confidence immensely. Weather delays can be frustrating in winter, but that\'s Chicago for you.',
        helpful: 14
      },
      {
        id: 'review-074',
        ...
        rating: 5,
        title: 'Perfect for Working Professionals',
        body: 'The Part 61 flexibility was perfect for my irregular work schedule. James Thompson worked with me to create a training plan that fit my life. Passed my checkride on the first try and felt well-prepared. Great school that doesn\'t get enough recognition.',
        helpful: 22
      },
      {
        id: 'review-075',
        reviewerName: 'Ryan O\'Connor',
        date: '2025-07-22',
        rating: 3,
        title: 'Good Instruction, Aircraft Availability Issues',
        body: 'The instructors are knowledgeable and professional. My main complaint is aircraft availability - with only 7 planes, scheduling can be challenging during busy periods. That said, the training I received was solid and prepared me well for my checkride.',
        helpful: 11
      }
    ],
    ...
    verificationDetails: {
      trustTier: 'Community-Verified',
      verificationTimestamp: '2025-06-10T00:00:00Z',
      dataSources: ['Student Reviews', 'FAA Records', 'Public Data'],
      lastUpdated: '2025-11-03T00:00:00Z'
    },

    contactInfo: {
      email: 'info@chicagoskyinstitute.com',
      phone: '(312) 555-0176',
      website: 'https://chicagoskyinstitute.com'
    }
  },
